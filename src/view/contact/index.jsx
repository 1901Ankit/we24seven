  ...
  return (
    <>
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <ul className="space-y-6 mt-6">
              ...
              <li className="flex gap-4 items-center">
                ...
                <a
                  href="mailto:prakhar.shukla@we24seven.in"
                  className="text-gray-600 font-medium hover:text-blue-600 transition"
                >
                  prakhar.shukla@we24seven.in
                </a>
              </li>
            </ul>
          </div>
      ...
      <div className="w-full h-[300px] md:h-[450px] mt-10 overflow-hidden rounded-xl border-2 border-blue-100 shadow-lg">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7017.980291741231!2d77.0386216!3d28.4195542!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d229e71ef44dd%3A0x9931b80f30d32dd3!2sJMD%20Megapolis!5e0!3m2!1sen!2sin!4v1750527856025!5m2!1sen!2sin"
